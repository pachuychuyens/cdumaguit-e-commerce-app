          ...
          <div class="mt-1 flex items-center gap-x-2">
            @php
              ...
              if($order->status == 'new')
                ...
                {
                  $status = '<span class="bg-grren-500 py-1 px-3 rounded text-white shadow">Delivered</span>';
                }
            ...
            @endphp
            <span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">{!! $status !!}</span>
          </div>
        </div>
      </div>
    </div>
            ...
            @foreach ($order_items as $item)
              ...
              <td class="py-4">
                <div class="flex items-center">
                  <img class="h-16 w-16 mr-4" src={{  $item->product && $item->product->image ? url('storage/' . $item->product->image[0]) : asset('no-image.png') }} }}
